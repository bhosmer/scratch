...
static auto registerer = torch::import()
  .impl("aten::add.Tensor",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::add_Tensor)
  .impl_UNBOXED("aten::add_.Tensor",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::add__Tensor)
  .impl_UNBOXED("aten::add.out",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::add_out_out)
  .impl("aten::div.Tensor",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::div_Tensor)
  .impl_UNBOXED("aten::div_.Tensor",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::div__Tensor)
  .impl_UNBOXED("aten::div.out",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::div_out_out)
  .impl_UNBOXED("aten::empty.memory_format",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::empty_memory_format)
  .impl_UNBOXED("aten::floor_divide",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::floor_divide)
  .impl_UNBOXED("aten::floor_divide_.Tensor",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::floor_divide__Tensor)
  .impl_UNBOXED("aten::floor_divide.out",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::floor_divide_out_out)
  .impl("aten::isnan",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::isnan)
  .impl_UNBOXED("aten::log1p_",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::log1p_)
  .impl_UNBOXED("aten::log1p.out",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::log1p_out_out)
  .impl("aten::mm",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::mm)
  .impl_UNBOXED("aten::mm.out",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::mm_out_out)
  .impl("aten::mul.Tensor",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::mul_Tensor)
  .impl_UNBOXED("aten::mul_.Tensor",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::mul__Tensor)
  .impl_UNBOXED("aten::mul.out",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::mul_out_out)
  .impl("aten::mv",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::mv)
  .impl("aten::narrow_copy",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::narrow_copy)
  .impl_UNBOXED("aten::sspaddmm.out",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::sspaddmm_out_out)
  .impl("aten::true_divide.Tensor",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::true_divide_Tensor)
  .impl_UNBOXED("aten::true_divide_.Tensor",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::true_divide__Tensor)
  .impl_UNBOXED("aten::true_divide.out",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::true_divide_out_out)
  .impl("aten::native_norm",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::native_norm)
  .impl_UNBOXED("aten::_sparse_sum_backward",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::_sparse_sum_backward)
  .impl_UNBOXED("aten::clone",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::clone)
  .impl_UNBOXED("aten::pow.Tensor_Scalar_out",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::pow_out_Tensor_Scalar_out)
  .impl("aten::pow.Tensor_Scalar",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::pow_Tensor_Scalar)
  .impl_UNBOXED("aten::zero_",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::zero_)
  .impl_UNBOXED("aten::sub.out",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::sub_out_out)
  .impl("aten::sub.Tensor",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::sub_Tensor)
  .impl_UNBOXED("aten::sub_.Tensor",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::sub__Tensor)
  .impl_UNBOXED("aten::addmm.out",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::addmm_out_out)
  .impl("aten::addmm",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::addmm)
  .impl_UNBOXED("aten::addmm_",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::addmm_)
  .impl_UNBOXED("aten::_sparse_coo_tensor_with_dims",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::_sparse_coo_tensor_with_dims)
  .impl_UNBOXED("aten::_sparse_coo_tensor_with_dims_and_tensors",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::_sparse_coo_tensor_with_dims_and_tensors)
  .impl_UNBOXED("aten::sparse_resize_",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::sparse_resize_)
  .impl_UNBOXED("aten::sparse_resize_and_clear_",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::sparse_resize_and_clear_)
  .impl("aten::sparse_mask",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::sparse_mask)
  .impl("aten::to_dense",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::to_dense)
  .impl("aten::sparse_dim",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::sparse_dim)
  .impl("aten::_dimI",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::_dimI)
  .impl("aten::dense_dim",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::dense_dim)
  .impl("aten::_dimV",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::_dimV)
  .impl("aten::_nnz",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::_nnz)
  .impl("aten::coalesce",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::coalesce)
  .impl("aten::is_coalesced",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::is_coalesced)
  .impl_UNBOXED("aten::_indices",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::_indices)
  .impl_UNBOXED("aten::_values",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::_values)
  .impl_UNBOXED("aten::_coalesced_",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::_coalesced_)
  .impl_UNBOXED("aten::indices",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::indices)
  .impl_UNBOXED("aten::values",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::values)
  .impl_UNBOXED("aten::hspmm.out",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::hspmm_out_out)
  .impl("aten::hspmm",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::hspmm)
  .impl_UNBOXED("aten::copy_sparse_to_sparse_",
                DispatchKey::SparseCPUTensorId,
                SparseCPUType::copy_sparse_to_sparse_)
  .impl("aten::index_select",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::index_select)
  .impl("aten::any",
        DispatchKey::SparseCPUTensorId, &SparseCPUType::any);
}
