...
static PyObject * THPVariable_copy_imag(PyObject* self_, PyObject* args, PyObject* kwargs);
static PyObject * THPVariable_copy_real(PyObject* self_, PyObject* args, PyObject* kwargs);
...
static PyObject * THPVariable_copy_imag(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "copy_imag(Tensor input, *, Tensor out=None)",
  }, /*traceable=*/true);
  ...
  if (_r.isNone(1)) {
    ...
    auto dispatch_copy_imag = [](const Tensor & self) -> Tensor {
      pybind11::gil_scoped_release no_gil;
      return self.copy_imag();
    };
    return wrap(dispatch_copy_imag(_r.tensor(0)));
  } else {
    // aten::copy_imag.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)
    auto dispatch_copy_imag_out = [](Tensor out, const Tensor & self) -> Tensor {
      pybind11::gil_scoped_release no_gil;
      return at::copy_imag_out(out, self);
    };
    return wrap(dispatch_copy_imag_out(_r.tensor(1), _r.tensor(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_copy_real(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "copy_real(Tensor input, *, Tensor out=None)",
  }, /*traceable=*/true);
  ...
  if (_r.isNone(1)) {
    ...
    auto dispatch_copy_real = [](const Tensor & self) -> Tensor {
      pybind11::gil_scoped_release no_gil;
      return self.copy_real();
    };
    return wrap(dispatch_copy_real(_r.tensor(0)));
  } else {
    // aten::copy_real.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)
    auto dispatch_copy_real_out = [](Tensor out, const Tensor & self) -> Tensor {
      pybind11::gil_scoped_release no_gil;
      return at::copy_real_out(out, self);
    };
    return wrap(dispatch_copy_real_out(_r.tensor(1), _r.tensor(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
