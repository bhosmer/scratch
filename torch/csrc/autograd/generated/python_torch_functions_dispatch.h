...
inline std::tuple<Tensor,Tensor> dispatch_cummax(const Tensor & self, Dimname dim, Tensor & values, Tensor & indices) {

  pybind11::gil_scoped_release no_gil;
  return at::cummax_out(values, indices, self, dim);
}
inline std::tuple<Tensor,Tensor> dispatch_cummax(const Tensor & self, Dimname dim) {

  pybind11::gil_scoped_release no_gil;
  return self.cummax(dim);
}
inline std::tuple<Tensor,Tensor> dispatch_cummax(const Tensor & self, int64_t dim, Tensor & values, Tensor & indices) {

  pybind11::gil_scoped_release no_gil;
  return at::cummax_out(values, indices, self, dim);
}
inline std::tuple<Tensor,Tensor> dispatch_cummax(const Tensor & self, int64_t dim) {

  pybind11::gil_scoped_release no_gil;
  return self.cummax(dim);
}
inline std::tuple<Tensor,Tensor> dispatch_cummin(const Tensor & self, Dimname dim, Tensor & values, Tensor & indices) {

  pybind11::gil_scoped_release no_gil;
  return at::cummin_out(values, indices, self, dim);
}
inline std::tuple<Tensor,Tensor> dispatch_cummin(const Tensor & self, Dimname dim) {

  pybind11::gil_scoped_release no_gil;
  return self.cummin(dim);
}
inline std::tuple<Tensor,Tensor> dispatch_cummin(const Tensor & self, int64_t dim, Tensor & values, Tensor & indices) {

  pybind11::gil_scoped_release no_gil;
  return at::cummin_out(values, indices, self, dim);
}
inline std::tuple<Tensor,Tensor> dispatch_cummin(const Tensor & self, int64_t dim) {
...
inline std::tuple<Tensor,Tensor,Tensor> dispatch_native_batch_norm(const Tensor & input, const Tensor & weight, const Tensor & bias, const Tensor & running_mean, const Tensor & running_var, bool training, double momentum, double eps, Tensor & out, Tensor & save_mean, Tensor & save_invstd) {
