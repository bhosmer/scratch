...
// copy_imag
static PyObject * THPVariable_copy_imag(PyObject* self_, PyObject* args)
{
  HANDLE_TH_ERRORS
  Tensor& self = reinterpret_cast<THPVariable*>(self_)->cdata;
  // aten::copy_imag(Tensor self) -> Tensor
  auto dispatch_copy_imag = [](Tensor & self) -> Tensor {
    pybind11::gil_scoped_release no_gil;
    return self.copy_imag();
  };
  return wrap(dispatch_copy_imag(self));
  END_HANDLE_TH_ERRORS
}

// copy_real
static PyObject * THPVariable_copy_real(PyObject* self_, PyObject* args)
{
  HANDLE_TH_ERRORS
  Tensor& self = reinterpret_cast<THPVariable*>(self_)->cdata;
  // aten::copy_real(Tensor self) -> Tensor
  auto dispatch_copy_real = [](Tensor & self) -> Tensor {
    pybind11::gil_scoped_release no_gil;
    return self.copy_real();
  };
  return wrap(dispatch_copy_real(self));
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_random_(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  switch (_r.idx) {
    ...
    case 1: {
      ...
      auto dispatch_random_ = [](Tensor & self, int64_t from, c10::optional<int64_t> to, Generator generator) -> Tensor {
        pybind11::gil_scoped_release no_gil;
...
PyMethodDef variable_methods[] = {
  ...
  {"copy_imag", (PyCFunction)THPVariable_copy_imag, METH_NOARGS, NULL},
  {"copy_real", (PyCFunction)THPVariable_copy_real, METH_NOARGS, NULL},
