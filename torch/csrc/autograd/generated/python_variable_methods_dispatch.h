...
inline std::tuple<Tensor,Tensor> dispatch_cummax(Tensor & self, Dimname dim) {

  pybind11::gil_scoped_release no_gil;
  return self.cummax(dim);
}
inline std::tuple<Tensor,Tensor> dispatch_cummax(Tensor & self, int64_t dim) {

  pybind11::gil_scoped_release no_gil;
  return self.cummax(dim);
}
inline std::tuple<Tensor,Tensor> dispatch_cummin(Tensor & self, Dimname dim) {

  pybind11::gil_scoped_release no_gil;
  return self.cummin(dim);
}
inline std::tuple<Tensor,Tensor> dispatch_cummin(Tensor & self, int64_t dim) {
